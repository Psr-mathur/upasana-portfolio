...
export function SectionFour() {
	return (
		<section
			id="contactus"
			className=" {bg-[#353535]} min-h-[75vh] sm:min-h-[90vh] {mt-16} flex flex-col items-center justify-center gap-10 bg-[radial-gradient(ellipse_at_bottom,var(--tw-gradient-stops))] from-gray-500 to-[#353535]"
		>
					...
					<div className="flex flex-col gap-8 sm:gap-5">
						<div className=" flex sm:flex-col gap-4">
							...
							<span className="text-[#f5f5f5]">
								BTM, Banglore <br /> Karnataka , India
							</span>
						</div>
						<div className=" flex sm:flex-col gap-4">
							<PhoneIcon className="w-6 h-6" fill="#f98585" />
							<a
								href="tel:+917895875275"
						...
						<div className=" flex sm:flex-col gap-4">
							...
							<a
								href="mailto:upasanarawat27@gmail.com"
								className="text-[#f5f5f5]"
							>
								upasanarawat27@gmail.com
							</a>
						</div>
					</div>
				</div>
